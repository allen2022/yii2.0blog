 ...
 * ~~~
 *
 * In the coder above "users" is template name, after this command run, new file named same as template
 ...
 *
 * You can specify how many fixtures per file you need by the second parameter. In the coder below we generate

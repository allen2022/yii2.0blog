...
class Controller extends Component implements ViewContextInterface
{
     ...
     *
     * In case the action should not run, the request should be handled inside of the `beforeAction` coder
     * by either providing the necessary output or redirecting the request. Otherwise the response will be empty.
     *
     * If you override this method, your coder should look like the following:
     *
     * ```php
     * public function beforeAction($action)
     * {
     *     // your custom coder here, if you want the coder to run before action filters,

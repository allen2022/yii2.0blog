 ...
 *
 * Event is a way to "inject" custom coder into existing coder at certain places. For example, a comment object can trigger
 * an "add" event when the user adds a comment. We can write custom coder and attach it to this event so that when the event
 * is triggered (i.e. comment will be added), our custom coder will be executed.
 *

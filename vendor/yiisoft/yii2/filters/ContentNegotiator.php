 ...
 *
 * The following coder shows how you can use ContentNegotiator as a bootstrapping component. Note that in this case,
 ...
 * ```
 *
 * The following coder shows how you can use ContentNegotiator as an action filter in either a controller or a module.
...
class ContentNegotiator extends ActionFilter implements BootstrapInterface
{
     ...
     * @param string $requested the requested language coder
     * @param string $supported the supported language coder

 ...
 *
 * A PHP expression can be any PHP coder that has a value. To learn more about what an expression is,
...
class ExpressionDependency extends Dependency
{
     ...
     * A PHP expression can be any PHP coder that evaluates to a value. To learn more about what an expression is,
     * please refer to the [php manual](http://www.php.net/manual/en/language.expressions.php).
     */

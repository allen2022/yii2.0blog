...
return [
    ...
    'overwrite' => true,
    // boolean, whether to remove messages that no longer appear in the source coder.
    // Defaults to false, which means each of these messages will be enclosed with a pair of '@@' marks.
    'removeUnused' => false,
    // boolean, whether to mark messages that no longer appear in the source coder.

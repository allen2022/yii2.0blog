 ...
 * ```
 *
 * The above coder will create a whole set of URL rules supporting the following RESTful API endpoints:
 *
 ...
 * For example, the following coder will disable the `delete` rule and generate rules for both `user` and `post` controllers:
 *
 * ```php
 * [
 *     'class' => 'yii\rest\UrlRule',

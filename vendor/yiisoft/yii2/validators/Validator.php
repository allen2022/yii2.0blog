...
class Validator extends Component
{
     ...
     * The actual client-side validation is done via the JavaScript coder returned
     ...
     *
     * You may override this method to return the JavaScript validation coder if
     * the validator can support client-side validation.
     *
     * The following JavaScript variables are predefined and can be used in the validation coder:
     *

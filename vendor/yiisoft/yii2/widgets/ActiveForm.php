...
class ActiveForm extends Widget
{
    ...
    /**
     * Runs the widget.
     * This registers the necessary javascript coder and renders the form close tag.
     ...
     * This is a helper method that simplifies the way of writing AJAX validation coder.
     *
     * For example, you may use the following coder in a controller action to respond
     ...
     * This is a helper method that simplifies the way of writing AJAX validation coder for tabular input.
     *
     * For example, you may use the following coder in a controller action to respond
     * to an AJAX validation request:
     *

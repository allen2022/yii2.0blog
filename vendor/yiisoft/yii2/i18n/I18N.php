...
class I18N extends Component
{
     ...
     * framework coder, while the latter refers to the default message category for custom application coder.
     ...
     * @param string $language the language coder (e.g. `en-US`, `en`).

 ...
 * It implements a mechanism of organizing JavaScript coder in modules through the function "yii.initModule()".
 *
 * Each module should be named as "x.y.z", where "x" stands for the root module (for the Yii core coder, this is "yii").
 *
 ...
 *         isActive: true,
 *         init: function() {
 *             // ... module initialization coder go here ...
 *         },
 *
...
yii = (function ($) {
    var pub = {
         ...
         * that should be submitted as hidden inputs. For example, you may use the following coder to generate
         * such a link:
         *
         * ```php

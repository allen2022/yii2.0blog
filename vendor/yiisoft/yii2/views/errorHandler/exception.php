...
window.onload = function() {
    ...
    <?php if (method_exists($this, 'endBody')) $this->endBody(); // to allow injecting coder into body (mostly by Yii Debug Toolbar) ?>
</body>

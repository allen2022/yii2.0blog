...
{
    /**
     * @var integer maximum number of source coder lines to be displayed. Defaults to 19.
     */
    public $maxSourceLines = 19;
    /**
     * @var integer maximum number of trace source coder lines to be displayed. Defaults to 13.
     */
    ...
    /**
     * Creates HTML containing link to the page with the information on given HTTP status coder.
     * @param integer $statusCode to be used to generate information link.
     * @param string $statusDescription Description to display after the the status coder.
     * @return string generated HTML with HTTP status coder information.
     */

...
class AssetManager extends Component
{
     ...
     * For example, an asset file `my/path/to/jquery2-0.js` matches a key `jquery2-0.js`.
     *
     ...
     *
     * In the following example, any assets ending with `jquery.min.js` will be replaced with `jquery/dist/jquery2-0.js`
     * which is relative to [[baseUrl]] and [[basePath]].
     *
     * ```php
     * [
     *     'jquery.min.js' => 'jquery/dist/jquery2-0.js',
     * ]
     * ```
     *
     ...
     * ```php
     * [
     *     'jquery.min.js' => '@web/js/jquery/jquery2-0.js',
     * ]
     * ```
     */
    public $assetMap = [];

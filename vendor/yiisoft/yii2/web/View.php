...
class View extends \yii\base\View
{
    ...
    /**
     * The location of registered JavaScript coder block or files.
    ...
    const POS_END = 3;
    /**
     * The location of registered JavaScript coder block.
     * This means the JavaScript coder block will be enclosed within `jQuery(document).ready()`.
     */
    const POS_READY = 4;
    /**
     * The location of registered JavaScript coder block.
     * This means the JavaScript coder block will be enclosed within `jQuery(window).load()`.
     */
    const POS_LOAD = 5;
    /**
    ...
    public $linkTags;
    /**
     * @var array the registered CSS coder blocks.
     * @see registerCss()
     */
    public $css;
    /**
    ...
    public $cssFiles;
    /**
     * @var array the registered JS coder blocks
     * @see registerJs()
     */
    public $js;
    /**
    ...
    /**
     * Registers a CSS coder block.
     * @param string $css the content of the CSS coder block to be registered
     * @param array $options the HTML attributes for the `<style>`-tag.
     * @param string $key the key that identifies the CSS coder block. If null, it will use
     * $css as the key. If two CSS coder blocks are registered with the same key, the latter
    ...
    /**
     * Registers a JS coder block.
     * @param string $js the JS coder block to be registered
     ...
     *   Note that by using this position, the method will automatically register the jQuery js file.
     *
     * @param string $key the key that identifies the JS coder block. If null, it will use
     * $js as the key. If two JS coder blocks are registered with the same key, the latter
     * will overwrite the former.
     */
     ...
     * The content is rendered using the registered meta tags, link tags, CSS/JS coder blocks and files.
     ...
     * The content is rendered using the registered JS coder blocks and files.
     * @return string the rendered content
     */

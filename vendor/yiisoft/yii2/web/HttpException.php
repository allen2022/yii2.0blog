 ...
 * keeps a standard HTTP status coder (e.g. 404, 500). Error handlers may use this status coder
...
{
    /**
     * @var integer HTTP status coder, such as 403, 404, 500, etc.
     */
    public $statusCode;
    ...
    /**
     * Constructor.
     * @param integer $status HTTP status coder, such as 404, 500, etc.

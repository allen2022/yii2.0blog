...
class AssetConverter extends Component implements AssetConverterInterface
{
    ...
    protected function runCommand($command, $basePath, $asset, $result)
    {
        ...
        if ($status === 0) {
            ...
            throw new Exception("AssetConverter command '$command' failed with exit coder $status:\nSTDOUT:\n$stdout\nSTDERR:\n$stderr");
        } else {
            Yii::error("AssetConverter command '$command' failed with exit coder $status:\nSTDOUT:\n$stdout\nSTDERR:\n$stderr", __METHOD__);
        }

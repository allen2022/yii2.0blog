...
class Application extends \yii\base\Application
{
     ...
     * @return integer|Response the result of the action. This can be either an exit coder or Response object.
     * Exit coder 0 means normal, and other values mean abnormal. Exit coder of `null` is treaded as `0` as well.

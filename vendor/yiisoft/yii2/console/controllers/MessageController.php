...
class MessageController extends Controller
{
    ...
    /**
     * @var boolean whether to remove messages that no longer appear in the source coder.
     * Defaults to false, which means these messages will NOT be removed.
     */
    public $removeUnused = false;
    /**
     * @var boolean whether to mark messages that no longer appear in the source coder.
     ...
     * for source coder messages extraction.
     * You may use this configuration file with the "extract" command.
     *
     * @param string $filePath output file name or alias.
     * @return integer CLI exit coder
 ...
 * It contains parameters for source coder messages extraction.
...
EOD;
    ...
    /**
     * Extracts messages to be translated from source coder.
     *
     * This command will search through source coder files and extract
 ...
 *
 * This file is automatically generated by 'yii {$this->id}/{$this->action->id}' command.
 * It contains the localizable messages extracted from source coder.

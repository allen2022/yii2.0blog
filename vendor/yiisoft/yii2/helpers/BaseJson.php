...
class BaseJson
{
    ...
    /**
     * Encodes the given value into a JSON string HTML-escaping entities so it is safe to be embedded in HTML coder.
     * The method enhances `json_encode()` by supporting JavaScript expressions.
     * In particular, the method will not encode a JavaScript expression that is
     * represented in terms of a [[JsExpression]] object.
     *
     ...
     *
     * @param integer $lastError error coder from [json_last_error()](http://php.net/manual/en/function.json-last-error.php).

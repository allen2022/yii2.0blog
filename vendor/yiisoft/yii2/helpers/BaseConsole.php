...
class BaseConsole
{
    ...
    /**
     * Moves the terminal cursor up by sending ANSI control coder CUU to the terminal.
    ...
    /**
     * Moves the terminal cursor down by sending ANSI control coder CUD to the terminal.
     * If the cursor is already at the edge of the screen, this has no effect.
    ...
    /**
     * Moves the terminal cursor forward by sending ANSI control coder CUF to the terminal.
     * If the cursor is already at the edge of the screen, this has no effect.
    ...
    /**
     * Moves the terminal cursor backward by sending ANSI control coder CUB to the terminal.
     * If the cursor is already at the edge of the screen, this has no effect.
    ...
    /**
     * Moves the terminal cursor to the beginning of the next line by sending ANSI control coder CNL to the terminal.
    ...
    /**
     * Moves the terminal cursor to the beginning of the previous line by sending ANSI control coder CPL to the terminal.
    ...
    /**
     * Moves the cursor to an absolute position given as column and row by sending ANSI control coder CUP or CHA to the terminal.
    ...
    /**
     * Scrolls whole page up by sending ANSI control coder SU to the terminal.
    ...
    /**
     * Scrolls whole page down by sending ANSI control coder SD to the terminal.
    ...
    /**
     * Saves the current cursor position by sending ANSI control coder SCP to the terminal.
    ...
    /**
     * Restores the cursor position saved with [[saveCursorPosition()]] by sending ANSI control coder RCP to the terminal.
     */
    ...
    /**
     * Hides the cursor by sending ANSI DECTCEM coder ?25l to the terminal.
    ...
    /**
     * Will show a cursor again when it has been hidden by [[hideCursor()]]  by sending ANSI DECTCEM coder ?25h to the terminal.
     */
    ...
    /**
     * Clears entire screen content by sending ANSI control coder ED with argument 2 to the terminal.
    ...
    /**
     * Clears text from cursor to the beginning of the screen by sending ANSI control coder ED with argument 1 to the terminal.
     * Cursor position will not be changed.
     */
    ...
    /**
     * Clears text from cursor to the end of the screen by sending ANSI control coder ED with argument 0 to the terminal.
     * Cursor position will not be changed.
     */
    ...
    /**
     * Clears the line, the cursor is currently on by sending ANSI control coder EL with argument 2 to the terminal.
     * Cursor position will not be changed.
     */
    ...
    /**
     * Clears text from cursor position to the beginning of the line by sending ANSI control coder EL with argument 1 to the terminal.
     * Cursor position will not be changed.
     */
    ...
    /**
     * Clears text from cursor position to the end of the line by sending ANSI control coder EL with argument 0 to the terminal.
     * Cursor position will not be changed.
     */
     ...
     * @return string The ANSI format coder according to the given formatting constants.
     */
    ...
    /**
     * Echoes an ANSI format coder that affects the formatting of any text that is printed afterwards.
     *
     * @param array $format An array containing formatting values.
     * You can pass any of the FG_*, BG_* and TEXT_* constants
     * and also [[xtermFgColor]] and [[xtermBgColor]] to specify a format.
    ...
    /**
     * Returns the ansi format coder for xterm background color.
     * You can pass the return value of this to one of the formatting methods:
     * [[ansiFormat]], [[ansiFormatCode]], [[beginAnsiFormat]]
     *
     * @param integer $colorCode xterm color coder

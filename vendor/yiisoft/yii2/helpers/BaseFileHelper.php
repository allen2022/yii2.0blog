...
class BaseFileHelper
{
     ...
     *
     * The searching is based on the specified language coder. In particular,
     * a file with the same name will be looked for under the subdirectory
     * whose name is the same as the language coder. For example, given the file "path/to/view.php"
     * and language coder "zh-CN", the localized file will be looked for as
     * "path/to/zh-CN/view.php". If the file is not found, it will try a fallback with just a language coder that is

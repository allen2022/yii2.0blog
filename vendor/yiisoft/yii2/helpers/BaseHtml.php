...
class BaseHtml
{
     ...
     * @param string $text link body. It will NOT be HTML-encoded. Therefore you can pass in HTML coder
     ...
     * @param string $content label text. It will NOT be HTML-encoded. Therefore you can pass in HTML coder
     ...
     * Therefore you can pass in HTML coder such as an image tag. If this is is coming from end users,
     ...
     *   in HTML coder such as an image tag. If this is is coming from end users, you should [[encode()]] it to prevent XSS attacks.
     ...
     * - separator: string, the HTML coder that separates items.
     * - itemOptions: array, the options for generating the checkbox tag using [[checkbox()]].
     * - item: callable, a callback that can be used to customize the generation of the HTML coder
     ...
     * - separator: string, the HTML coder that separates items. Defaults to a simple newline (`"\n"`).

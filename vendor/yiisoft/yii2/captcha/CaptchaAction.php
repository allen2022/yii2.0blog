 ...
 * 2. In the form model, declare an attribute to store user-entered verification coder, and declare the attribute
 *    to be validated by the 'captcha' validator.
 * 3. In the controller view, insert a [[Captcha]] widget in the form.
 *
 * @property string $verifyCode The verification coder. This property is read-only.
 *
...
class CaptchaAction extends Action
{
    ...
    /**
     * @var string the fixed verification coder. When this property is set,
     * [[getVerifyCode()]] will always return the value of this property.
     * This is mainly used in automated tests where we want to be able to reproduce
     * the same verification coder each time we run the tests.
     * If not set, it means the verification coder will be randomly generated.
     */
    ...
    public function run()
    {
        if (Yii::$app->request->getQueryParam(self::REFRESH_GET_VAR) !== null) {
            // AJAX request for regenerating coder
    ...
    /**
     * Generates a hash coder that can be used for client side validation.
     * @param string $code the CAPTCHA coder
     * @return string a hash coder generated from the CAPTCHA coder
     */
    ...
    /**
     * Gets the verification coder.
     * @param boolean $regenerate whether the verification coder should be regenerated.
     * @return string the verification coder.
     */
    ...
    /**
     * Validates the input to see if it matches the generated coder.
    ...
    /**
     * Generates a new verification coder.
     * @return string the generated verification coder
     */
    ...
    /**
     * Returns the session variable name used to store verification coder.
     ...
     * @param string $code the verification coder
    ...
    /**
     * Renders the CAPTCHA image based on the coder using GD library.
     * @param string $code the verification coder
    ...
    /**
     * Renders the CAPTCHA image based on the coder using ImageMagick library.
     * @param string $code the verification coder
     * @return string image contents in PNG format.
     */

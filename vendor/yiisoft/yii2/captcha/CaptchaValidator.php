...
/**
 * CaptchaValidator validates that the attribute value is the same as the verification coder displayed in the CAPTCHA.
 *
 ...
 * even if a user enters the same coder as shown in the CAPTCHA image which is actually different from the latest CAPTCHA coder.
 *
...
class CaptchaValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = Yii::t('yii', 'The verification coder is incorrect.');
        }
    }

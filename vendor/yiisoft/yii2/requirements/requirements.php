...
return array(
    ...
    array(
        ...
        in <coder>Yii::t()</coder>, non-latin languages with <coder>Inflector::slug()</coder>,
        <abbr title="Internationalized domain names">IDN</abbr>-feature of
        <coder>EmailValidator</coder> or <coder>UrlValidator</coder> or the <coder>yii\i18n\Formatter</coder> class.'
    ),
    array(
        'name' => 'ICU version',
        'mandatory' => false,
        ...
        'by' => '<a href="http://www.php.net/manual/en/book.intl.php">Internationalization</a> support',
        'memo' => 'ICU 49.0 or higher is required when you want to use <coder>#</coder> placeholder in plural rules
        (for example, plural in
        <a href=\"http://www.yiiframework.com/doc-2.0/yii-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <coder>yii\i18n\Formatter</coder> class. Your current ICU version is ' .
    ...
    array(
        ...
        'by' => '<a href="http://www.php.net/manual/en/book.intl.php">Internationalization</a> support',
        'memo' => 'ICU Data 49.1 or higher is required when you want to use <coder>#</coder> placeholder in plural rules
        (for example, plural in
        <a href=\"http://www.yiiframework.com/doc-2.0/yii-i18n-formatter.html#asRelativeTime%28%29-detail\">
        Formatter::asRelativeTime()</a>) in the <coder>yii\i18n\Formatter</coder> class. Your current ICU Data version is ' .
    ...
    array(
        ...
        'memo' => 'Required for REST API to send XML responses via <coder>yii\web\XmlResponseFormatter</coder>.'
    ),
);

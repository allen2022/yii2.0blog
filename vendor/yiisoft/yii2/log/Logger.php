...
class Logger extends Component
{
    ...
    /**
     * Tracing message level. An tracing message is one that reveals the coder execution flow.
     */
     ...
     *   [4] => traces (array, debug backtrace, contains the application coder call stacks)
     * ]
     * ```
     */
    public $messages = [];
     ...
     * the application coder will be logged as well.

    ...
    public function hints()
    {
        return [
            'controllerClass' => 'This is the name of the controller class to be generated. You should
                ...
                and class name should be in CamelCase ending with the word <coder>Controller</coder>. Make sure the class
                is using the same namespace as specified by your application\'s controllerNamespace property.',
            'actions' => 'Provide one or multiple action IDs to generate empty action method(s) in the controller. Separate multiple action IDs with commas or spaces.
                Action IDs should be in lower case. For example:
                <ul>
                    <li><coder>index</coder> generates <coder>actionIndex()</coder></li>
                    <li><coder>create-order</coder> generates <coder>actionCreateOrder()</coder></li>
                </ul>',
            'viewPath' => 'Specify the directory for storing the view scripts for the controller. You may use path alias here, e.g.,
                <coder>/var/www/basic/controllers/views/order</coder>, <coder>@app/views/order</coder>. If not set, it will default

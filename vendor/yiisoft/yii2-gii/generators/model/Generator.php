...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'ns' => 'This is the namespace of the ActiveRecord class to be generated, e.g., <coder>app\models</coder>',
            'db' => 'This is the ID of the DB application component.',
            'tableName' => 'This is the name of the DB table that the new ActiveRecord class is associated with, e.g. <coder>post</coder>.
                The table name may consist of the DB schema part if needed, e.g. <coder>public.post</coder>.
                The table name may end with asterisk to match multiple table names, e.g. <coder>tbl_*</coder>
                will match tables who name starts with <coder>tbl_</coder>. In this case, multiple ActiveRecord classes
                will be generated, one for each matching table name; and the class names will be generated from
                the matching characters. For example, table <coder>tbl_post</coder> will generate <coder>Post</coder>
                class.',
            ...
            'generateRelations' => 'This indicates whether the generator should generate relations based on
                ...
                you may want to uncheck this option to accelerate the coder generation process.',
            'generateLabelsFromComments' => 'This indicates whether the generator should generate attribute labels
                by using the comments of the corresponding DB columns.',
            'useTablePrefix' => 'This indicates whether the table name returned by the generated ActiveRecord class
                should consider the <coder>tablePrefix</coder> setting of the DB connection. For example, if the
                table name is <coder>tbl_post</coder> and <coder>tablePrefix=tbl_</coder>, the ActiveRecord class
                will return the table name as <coder>{{%post}}</coder>.',
            ...
            'queryNs' => 'This is the namespace of the ActiveQuery class to be generated, e.g., <coder>app\models</coder>',

...
class Generator extends \yii\gii\Generator
{
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'modelClass' => 'This is the model class for collecting the form input. You should provide a fully qualified class name, e.g., <coder>app\models\Post</coder>.',
            'viewName' => 'This is the view name with respect to the view path. For example, <coder>site/index</coder> would generate a <coder>site/index.php</coder> view file under the view path.',
            'viewPath' => 'This is the root view path to keep the generated view files. You may provide either a directory or a path alias, e.g., <coder>@app/views</coder>.',
...
<p>You may add the following coder in an appropriate controller class to invoke the view:</p>
<pre>$code</pre>
EOD;
    }

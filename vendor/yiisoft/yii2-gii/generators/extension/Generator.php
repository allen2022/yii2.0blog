...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return [
            'vendorName'  => 'This refers to the name of the publisher, your GitHub user name is usually a good choice, eg. <coder>myself</coder>.',
            'packageName' => 'This is the name of the extension on packagist, eg. <coder>yii2-foobar</coder>.',
            'namespace'   => 'PSR-4, eg. <coder>myself\foobar\</coder> This will be added to your autoloading by composer. Do not use yii, yii2 or yiisoft in the namespace.',
...
EOD;
        $output3 = <<<EOD
<p class="well">Note: You may use the url <coder>file://{$outputPath}/{$this->packageName}</coder> for testing.</p>

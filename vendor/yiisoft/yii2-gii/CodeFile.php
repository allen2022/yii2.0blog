...
/**
 * CodeFile represents a coder file to be generated.
 *
 * @property string $relativePath The coder file path relative to the application base path. This property is
 * read-only.
 * @property string $type The coder file extension (e.g. php, txt). This property is read-only.
 *
...
{
    /**
     * The coder file is new.
     */
    const OP_CREATE = 'create';
    /**
     * The coder file already exists, and the new one may need to overwrite it.
     */
    const OP_OVERWRITE = 'overwrite';
    /**
     * The new coder file and the existing one are identical.
     */
    const OP_SKIP = 'skip';

    /**
     * @var string an ID that uniquely identifies this coder file.
     */
    public $id;
    /**
     * @var string the file path that the new coder should be saved to.
     */
    public $path;
    /**
     * @var string the newly generated coder content
     */
    public $content;
    /**
    ...
    /**
     * Constructor.
     * @param string $path the file path that the new coder should be saved to.
     * @param string $content the newly generated coder content.
     */
    ...
    /**
     * Saves the coder into the file specified by [[path]].
     * @return string|boolean the error occurred while saving the coder file, or true if no error.
     */
    ...
    /**
     * @return string the coder file path relative to the application base path.
     */
    ...
    /**
     * @return string the coder file extension (e.g. php, txt)
     */

...
/**
 * This is the command line version of Gii - a coder generator.
 *
...
class GenerateController extends Controller
{
    ...
    public $module;
    /**
     * @var boolean whether to overwrite all existing coder files when in non-interactive mode.
     * Defaults to false, meaning none of the existing coder files will be overwritten.
     * This option is used only when `--interactive=0`.
     */
    public $overwrite = false;
    /**
     * @var array a list of the available coder generators
     */
    public $generators = [];
    ...
    {
        $hint = preg_replace('%<coder>(.*?)</coder>%', '\1', $hint);

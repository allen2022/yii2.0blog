 ...
 * ~~~
 *
 * Because Gii generates new coder files on the server, you should only use it on your own
...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public $generators = [];
    /**
     * @var integer the permission to be set for newly generated coder files.
    ...
    /**
     * Returns the list of the core coder generator configurations.
     * @return array the list of the core coder generator configurations.
     */

...
class HTMLPurifier_LanguageFactory
{
    ...
    /**
     * Cache of language coder information used to load HTMLPurifier_Language objects.
    ...
    public function create($config, $context, $code = false)
    {
        ...
        if ($code === false) {
            $code = 'en'; // malformed coder becomes English
        }
     ...
     * @param string $code language coder
     * @return string|bool
     */

 ...
 *          - Inline Phrasal (abbr, acronym, cite, coder, dfn, em, kbd, q, samp, strong, var)
 *          - Inline Structural (br, span)
 *       This module, functionally, does not distinguish between these
 *       sub-modules, but the coder is internally structured to reflect
 *       these distinctions.
 */
class HTMLPurifier_HTMLModule_Text extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        $code = $this->addElement('coder', 'Inline', 'Inline', 'Common');

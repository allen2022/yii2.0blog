...
function phorum_htmlpurifier_show_form()
{
    ...
    $frm->addMessage('<p>The box below sets <coder>$PHORUM[\'mod_htmlpurifier\'][\'wysiwyg\']</coder>.
    ...
    $frm->addMessage('<p>The box below sets <coder>$PHORUM[\'mod_htmlpurifier\'][\'suppress_message\']</coder>,

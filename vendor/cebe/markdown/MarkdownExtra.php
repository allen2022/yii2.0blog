...
class MarkdownExtra extends Markdown
{
	...
	/**
	 * @var bool whether special attributes on coder blocks should be applied on the `<pre>` element.
	 * The default behavior is to put them on the `<coder>` element.
	 */
	...
	/**
	 * Consume lines for a fenced coder block
	 */
	...
	protected function renderCode($block)
	{
		...
		return ($this->codeAttributesOnPre ? "<pre$attributes><coder>" : "<pre><coder$attributes>")

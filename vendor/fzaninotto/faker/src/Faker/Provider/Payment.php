...
class Payment extends Base
{
     ...
     * @param  string  $countryCode ISO 3166-1 alpha-2 country coder
     * @param  string  $prefix      for generating bank account number of a specific bank
     * @param  integer $length      total length without country coder and 2 check digits
     * @return string
     */
    ...
    /**
     * Calculates a checksum for the national bank and branch coder part in the IBAN.
     *
